    ...
    private class ListDirAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.mDirName = convertView.findViewById(R.id.id_item_name);
                holder.mDirCount = convertView.findViewById(R.id.id_item_count);
                holder.imvVideo = convertView.findViewById(R.id.imv_video);
